...
export default function NodeListItem({ nodeData }) {
  const address = Object.keys(nodeData)[0];
  const [
    protocolVersion,
    userAgent,
    connectedSince,
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col gap-1 p-1">
        <p className="border border-black cursor-default px-1">
      ...
      {/* Height */}
      <div className="flex flex-col gap-1 p-1">
        <p className="border border-black text-center cursor-default px-1">
          {height}
        </p>
      </div>
